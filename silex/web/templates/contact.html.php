...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <?php if ($success == 1) : ?>
                <div class="alert alert-success\"><strong><span class="glyphicon glyphicon-send"></span> Success!
                        Message
                        sent.</strong></div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon"><i class="glyphicon glyphicon-ok form-control-feedback"></i>
                        </span>
                    </div>
                </div>
                <div class="form-group">
